...
Now that we have the identifier for the categories information, we can place that into our query selector method.  From the Console, type in `document.querySelector('#mw-normal-catlinks')`, and you'll see that this selects the appropriate element.
...
So to select the correct element we typed in and press Enter.
